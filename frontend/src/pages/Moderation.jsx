        ...
        return (
            <div className="flex items-center justify-center min-h-screen bg-gray-50">
                <div className="text-center p-8 max-w-md w-full bg-white rounded-lg shadow-lg">
                    ...
                    <p className="mt-4 text-lg text-gray-700">Загрузка настроек модерации...</p>
                </div>
            </div>
        );
    }
            ...
            <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-md overflow-hidden">
                <div className="p-6 md:p-8">
                    <div className="flex items-center mb-6">
                        ...
                        <h1 className="text-2xl font-bold text-gray-800">Настройки модерации чата</h1>
                    </div>
                    ...
                    {Object.keys(settings).length === 0 ? (
                        <div className="text-center py-8">
                            ...
                            <p className="mt-4 text-gray-500">Настройки модерации не найдены</p>
                        </div>
